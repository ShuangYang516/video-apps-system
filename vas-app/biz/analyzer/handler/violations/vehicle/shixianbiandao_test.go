...
type VehicleShixianbiandaoTestSuite struct {
	suite.Suite
	handler *ShixianbiandaoViolation
}

func (suite *VehicleShixianbiandaoTestSuite) SetupTest() {
	suite.handler = NewShixianbiandaoViolation(
		context.TODO(),
		&ShixianbiandaoViolationConfig{
			Timeout: 60,
		},
	)
}

func (suite *VehicleShixianbiandaoTestSuite) TearDownTest() {
	if suite.handler != nil {
		suite.handler.Release()
	}
}

func (suite *VehicleShixianbiandaoTestSuite) TestCase1() {
	var (
		err     error
...
func (suite *VehicleShixianbiandaoTestSuite) TestCase2() {
	var (
		err     error
		imgBody = &proto.ImageBody{}
		data    proto.VehicleModelData
...
func (suite *VehicleShixianbiandaoTestSuite) TestCase3() {
	var (
		err     error
		imgBody = &proto.ImageBody{}
		data    proto.VehicleModelData
...
func (suite *VehicleShixianbiandaoTestSuite) TestCase4() {
	var (
		err     error
		imgBody = &proto.ImageBody{}
		data    proto.VehicleModelData
...
func TestShixianbiandaoTestSuite(t *testing.T) {
	suite.Run(t, new(VehicleShixianbiandaoTestSuite))
}
func (suite *VehicleShixianbiandaoTestSuite) TestCase5() {
	var (
		err     error
		imgBody = &proto.ImageBody{}
		data    proto.VehicleModelData
